		...
		<div class="head-view">
			<ul>
				...
				<li><a href="photos.php" title="Photos"><label>Photos</label></a></li>
                                <li><a href="search.php" title="Search"><label>Search</label></a></li>
...
<?php
	include("includes/database.php");
			$query=mySQLi_query($conn,"SELECT * from user where user_id='$id' order by user_id DESC") or die(mySQL_error($conn));
...
<?php
	include("includes/database.php");
			$query=mySQLi_query($conn,"SELECT * from post LEFT JOIN user on user.user_id = post.user_id order by post_id DESC") or die(mySQL_error($conn));
			while($row=mySQLi_fetch_array($query)){
...
<?php
	include("includes/database.php");
			$comment=mySQLi_query($conn,"SELECT * from comments where post_id='$post_id' order by post_id DESC") or die(mySQL_error($conn));
...
?>
		 ...
		 <form  method="POST" action="comment.php">			
			<div class="comment-area">
						...
						<?php $image=mysqli_query($conn,"select * from user where user_id='$id'")or die(mysql_error($conn));
